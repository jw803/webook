...
import (
	...
	dao "github.com/jw803/webook/internal/repository/dao"
...
func (m *MockUserDAO) FindByEmail(ctx context.Context, email string) (dao.Users, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByEmail", ctx, email)
	ret0, _ := ret[0].(dao.Users)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserDAO) FindById(ctx context.Context, id int64) (dao.Users, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) FindByPhone(ctx context.Context, phone string) (dao.Users, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) FindByWechat(ctx context.Context, openID string) (dao.Users, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) Insert(ctx context.Context, u dao.Users) error {
	m.ctrl.T.Helper()
