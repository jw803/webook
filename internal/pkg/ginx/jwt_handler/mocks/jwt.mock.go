...
// Source: internal/interface/web/jwtx/jwt.go
//
...
// Package hdljwtmocks is a generated GoMock package.
package hdljwtmocks
...
import (
	...
	jwtx "github.com/jw803/webook/internal/interface/web/jwtx"
...
func (m *MockHandler) ClearToken(ctx *gin.Context, claim *jwtx.UserClaims) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClearToken", ctx, claim)
	ret0, _ := ret[0].(error)
	return ret0
}

// ClearToken indicates an expected call of ClearToken.
func (mr *MockHandlerMockRecorder) ClearToken(ctx, claim any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClearToken", reflect.TypeOf((*MockHandler)(nil).ClearToken), ctx, claim)
}
